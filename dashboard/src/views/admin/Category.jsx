...
import { FaEdit, FaImages, FaTrash } from "react-icons/fa";
...
function Category() {
    ...
    //Variable detat pour les images a add
    ...
    return (
        <div className="px-2 lg:px-7 pt-5">
            ...
            <div className="flex flex-wrap w-full">
                                ...
                                <tbody>
                                    {categories.map((order, index) => (
                                        <tr key={index}>
                                            ...
                                            <td scope="row" className="py-1 px-4 font-medium whitespace-nowrap">
                                                <img className="w-[45px] h-[45px]" src={order.image} alt="" />
                                            </td>
                                            <td scope="row" className="py-1 px-4 font-medium whitespace-nowrap">
                                                {order.name}
                                            </td>
                ...
                {/* Code pour afficher la DIV lorsque l'écran est petit. */}
                <div
                    className={`w-[320px] lg:w-5/12 translate-x-100 lg:relative lg:right-0 fixed ${
                        showDiv ? "right-0" : "-right-[340px]"
                    } z-[8888] top-0 transition-all duration-500"
                    }`}
                >
                    <div className="w-full pl-5">
                        <div className="bg-[#6a5fdf] h-screeen lg:h-auto px-3 py-2 lg:rounded-md text-[#d0d2d6]">
                            <div className="flex justify-between items-center mb-4">
                                <h1 className="text-[#d0d2d6] font-semibold text-xl mb-4 w-full text-center">
                                    Add Category
                                </h1>

                                <div onClick={() => setShowDiv(false)} className="block lg:hidden">
                                    <IoMdCloseCircle />
                                </div>
                            </div>
                            <form onSubmit={add_category}>
                                <div className="flex flex-col w-full gap-1 mb-3">
                                    ...
                                    <input
                                        ...
                                        className="px-4 py-2 focus:border-indigo-500 outline-none bg-[#ffffff] border border-slate-700 text-[#000000]"
                                        type="text"
                                        id="name"
                                        name="category_name"
                                ...
                                <div className="">
                                    ...
                                    <div className="mt-4">
                                        <button
                                            ...
                                            className="bg-red-800 w-full hover:shadow-red-300/50 hover:shadow-lg text-white rounded-md px700 py-2 mb-3"
                                        >
                                            {loader ? (
