            ...
            <div className="w-full p-4 bg-[#6a5fdf] rounded-md">
                <div className="flex justify-between items-center p-4">
                    ...
                    <select
                        name=""
                        id=""
                        className="px-4 py-2 focus:border-indigo-500 outline-none bg-[#475569] border boder-salte-700 rounded-md text-[#d0d2d6]"
                    >
                        ...
                        <div className="w-[30%]">
                            <div className="pr-3 text-[#d0d2d6] text-lg">
                                <div className="flex flex-col gap-1">
                                    <h2 className="pb-2 font-semibold">Deliver to : Conrad</h2>
                                    <p className="text-sm">
                                        <span>113, rue du Général de Gaulle</span>
                                    </p>
                                </div>
                                ...
                                <span>Price : £</span>
                                <div className="mt-4 flex-col gap-4  bg-[#8288ed] rounded-md">
